...
},{}],"src/utils/drawing.ts":[function(require,module,exports) {
"use strict";
...
exports.setText = function (context, options) {
  ...
  context.font = combined.fontSize + " " + combined.fontFamily; // ctx.fillText("width:" + ctx.measureText(txt).width, 10, 50)
...
},{"./api":"src/api.ts","./utils/drawing":"src/utils/drawing.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
